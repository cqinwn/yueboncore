    ...
    public IEnumerable<Role> HasData()
    {
        return new[] {
            ...
            new Role{
                ...
                AllowDelete= false,
                SortCode= 8,
                DataScope=Commons.Enums.RoleDataScopeEnum.Self,
                DeleteMark= false,
                EnabledMark= true,
                Description= "",
                CreateOrgId=9165855286886470,
            ...
            new Role{
                ...
                AllowDelete= false,
                SortCode= 3,
                DataScope=Commons.Enums.RoleDataScopeEnum.All,
                DeleteMark= false,
                EnabledMark= true,
                Description= "",
                CreateOrgId=9165855286886470,
