  ...
  <div class="navbar">
    ...
    <div class="right-menu">
      <template v-if="getters.device !== 'mobile'">
        ...
        <el-tooltip :content="$t('layout.giturl')" effect="dark" placement="bottom">
          <ruo-yi-git id="yuebon-git" class="right-menu-item hover-effect" />
        </el-tooltip>

        <el-tooltip :content="$t('layout.docurl')" effect="dark" placement="bottom">
          <ruo-yi-doc id="yuebon-doc" class="right-menu-item hover-effect" />
        </el-tooltip>

        <screenfull id="screenfull" class="right-menu-item hover-effect" />

        <el-tooltip :content="$t('layout.layoutsize')" effect="dark" placement="bottom">
          <size-select id="size-select" class="right-menu-item hover-effect" />
        </el-tooltip>
        <lang-select class="right-menu-item hover-effect" />
        <el-dropdown class="el-dropdown-link right-menu-item" trigger="click" @command="handlerSysType">
          <div class="subSystem">
            {{ $t('layout.systemNowTip')}}：{{ activeSystemName }}({{ $t('layout.switch')}})
          ...
          <template #dropdown>
            <el-dropdown-menu>
              <router-link to="/usercenter/index">
                <el-dropdown-item> {{ $t('layout.usercenter')}}</el-dropdown-item>
              </router-link>
              <el-dropdown-item command="setLayout">
                <span>{{ $t('layout.layoutSet')}}</span>
              </el-dropdown-item>
