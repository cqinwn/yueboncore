<template>
  <el-drawer v-model="showSettings" :withHeader="false" direction="rtl" size="300px">
    ...
    <el-button type="primary" plain icon="DocumentAdd" @click="saveSetting">{{$t('button.btnSave')}}</el-button>
    <el-button plain icon="Refresh" @click="resetSetting">{{$t('button.btnReset')}}</el-button>
  </el-drawer>
...
function saveSetting() {
  ...
  saveThemeConfig(layoutSetting).then(res => {
    if (res.Success) {
