    ...
    <el-dialog ref="dialogEditMenuForm" draggable :title="editMenuFormTitle+'模块/菜单'" append-to-body v-model="dialogEditFormVisible" width="40%">
      <el-form ref="editMenuFromRef" :model="editMenuFrom" :rules="rules">
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="英文名称" v-if="editMenuFrom.MenuType != 'F'" :label-width="formLabelWidth" prop="EnglishFullName">
              <el-input v-model="editMenuFrom.EnglishFullName" :placeholder="'请输入'+formShowTitle+'英文名称'" autocomplete="off" clearable />
            </el-form-item>
          </el-col>
