  ...
  <div class="app-container">
    ...
    <el-card>
      ...
      >
        ...
        <el-table-column prop="EnCode" label="仓库编码" sortable="custom" width="180" />
        <el-table-column prop="Title" label="仓库名称" sortable="custom" width="180" />
        <el-table-column prop="WhType" label="类型" sortable="custom" width="90" align="center" />
        <el-table-column
          label="是否启用"
          sortable="custom"
          width="120"
        ...
        <el-table-column prop="LastModifyTime" label="更新时间" sortable>
          <template
            slot-scope="scope"
          >{{ scope.row.LastModifyTime !== null?scope.row.LastModifyTime:scope.row.CreatorTime }}</template>
        </el-table-column>
      </el-table>
    ...
    >
      <el-form ref="editFrom" :model="editFrom" :rules="rules">
        ...
        <el-form-item label="属性" :label-width="formLabelWidth" prop="WhType">
          <el-select v-model="editFrom.WhType" clearable placeholder="请选属性">
            <el-option
  ...
  methods: {
    ...
    bindEditInfo: function() {
      getWarehouseDetail(this.currentId).then(res => {
        ...
        this.editFrom.WhType = res.ResData.WhType
      })
    },
    /**
     * 新增/修改保存
