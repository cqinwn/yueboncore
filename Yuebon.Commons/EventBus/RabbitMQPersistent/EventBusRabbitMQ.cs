...
using Yuebon.Commons.EventBus;
using Yuebon.Commons.EventBus.Abstractions;
using Yuebon.Commons.EventBus.Events;
using Yuebon.Commons.EventBus.Extensions;

namespace Yuebon.Commons.EventBus.RabbitMQPersistent;
/// <summary>
/// 基于RabbitMQ的事件总线
/// </summary>
public class EventBusRabbitMQ : IEventBus, IDisposable
{
    const string BROKER_NAME = "yuebon_event_bus";
    const string AUTOFAC_SCOPE_NAME = "yuebon_event_bus";
