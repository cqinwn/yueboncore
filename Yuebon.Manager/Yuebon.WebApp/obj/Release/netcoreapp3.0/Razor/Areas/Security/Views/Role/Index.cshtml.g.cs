#pragma checksum "D:\netcorespace\YueGroup\权限管理\Yuebon.Manager\Yuebon.WebApp\Areas\Security\Views\Role\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "9eb68e35af1ea2cd664a36ed42c9676b9632b948"
// <auto-generated/>
...
#nullable restore
#line 7 "D:\netcorespace\YueGroup\权限管理\Yuebon.Manager\Yuebon.WebApp\Areas\Security\Views\Role\Index.cshtml"
using Yuebon.WebApp.Commons;

#line default
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"9eb68e35af1ea2cd664a36ed42c9676b9632b948", @"/Areas/Security/Views/Role/Index.cshtml")]
...
#line hidden
#nullable disable
            WriteLiteral(@"                        <button type=""button"" class=""btn btn-secondary"" onclick=""EnableByIds('0','/Security/Role')""><i class="" fa fa-stop-circle""></i>禁用</button>
...
#line hidden
#nullable disable
            WriteLiteral(@"                        <button id=""btn_delete"" type=""button"" class=""btn btn-warning"" onclick=""DeleteByIds('/Security/Role/DeleteSoftByIds')"">
        ...
        <div class=""modal-content"">
            ...
            WriteLiteral(@">==请选择==</option>
                    ...
                    <div class=""form-group"">
                        <div class=""row"">
          ");
            WriteLiteral(@"                  <label for=""Type"" class=""col-form-label col-3 text-right"">角色类型:</label>
            ...
            WriteLiteral(@">=请选择=</option>
                    ...
                    <div class=""form-group"">
                        <div class=""row"">
                            ...
                            <div class=""col-9"">
                                <l");
            WriteLiteral(@"abel for=""EnabledMark"">
            ...
            WriteLiteral("rol\" id=\"Description\" name=\"Description\"></textarea>\r\n                    </div>\r\n                    <input type=\"hidden\" id=\"Id\" name=\"Id\"");
...
<div class=""modal fade"" id=""roleAuthorizeFormModal"" tabindex=""-1"" role=""dialog"" aria-labelledby=""roleAuthorizeFormModalLabel"" aria-hidden=""true"">
    <div class=""modal-dialog"" role=""document"">
        <div class=""modal-content"">
          ...
          ");
            WriteLiteral("  </form>\r\n        </div>\r\n    </div>\r\n</div>\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("link", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "9eb68e35af1ea2cd664a36ed42c9676b9632b94818096", async() => {
            }
            );
            ...
            WriteLiteral("\r\n\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "9eb68e35af1ea2cd664a36ed42c9676b9632b94819215", async() => {
            }
            );
            __Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.Razor.TagHelpers.UrlResolutionTagHelper>();
            __tagHelperExecutionContext.Add(__Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper);
 ...
 ");
                ...
                $('#tree_function').treeview({
                    ...
                    onNodeChecked: function (event, node) { //选中节点 
                        ...
                        if (selectNodes) { //子节点不为空，则选中所有子节点       
                            $('#tree_functio");
            WriteLiteral(@"n').treeview('checkNode', [selectNodes, { silent: true }]);
                        }
                    ...
                    onNodeUnchecked: function (event, node) { //取消选中节点  
                        ...
                        //var selectNodes = getCh");
            WriteLiteral(@"ildNodeIdArr(node);
                        //setParentNodeCheck(node);
                    }
                });
            },
            ...
            success: function (data) {
                $('#tree_data').treeview({
                    ...
                    onNodeChecked: function (event, node) { //选中节点 
                        //alert(JSON.stringify(node));
                        var selectNodes ");
            WriteLiteral(@"= getChildNodeIdArr(node); //获取所有子节点      
                        if (selectNodes) { //子节点不为空，则选中所有子节点       
                    ...
                    onNodeUnchecked: function (event, node) { //取消选中节点  
                        ...
                        //// 取消节点 父节点取消
             ");
            WriteLiteral(@"           //var parentNode = $(""#tree_function"").treeview(""getNode"", node.parentId);  //获取父节点
    ...
    function ShowEditOrViewDialog(view) {
        ...
        if (view == null) {
            ...
            $('#addForm");
            WriteLiteral(@"Modal').find('.modal-title').text(""新增"");
            $(""#Id"").val("""");
        } else if (view == ""edit"") {
            //处理修改的信息
            $('#addFormModal').modal('show');  //手动显示
        ...
        $(""#btnSaveOK"").click(function () {
           ...
           ");
            WriteLiteral(@"             required: true,
                ...
                errorClass: 'help-b");
            WriteLiteral(@"lock help-block-error',
                focusInvalid: true,
    ...
    function setParentNodeCheck(node) {
        ...
        if (parentNode.nodes) {
           ");
            WriteLiteral(@" var checkedCount = 0;
  ...
  ");
            WriteLiteral(@"                  ts.push(node.nodes[x].nodeId);
                }
                if (node.nodes[x].nodes) {
