...
namespace Yuebon.Commons.IServices
{
    ...
    public interface IService<T,TODto> : IDisposable where T : class
    {
        ...
        /// <returns></returns>
        bool DeleteSoft(bool bl, object id, string userId = null);
        ...
        /// <returns></returns>
        Task<bool> DeleteSoftAsync(bool bl, object id, string userId = null);
        ...
        /// <returns></returns>
        bool SetEnabledMark(bool bl, object id, string userId = null);
        ...
        /// <returns></returns>
        Task<bool> SetEnabledMarkAsync(bool bl, object id, string userId = null);
