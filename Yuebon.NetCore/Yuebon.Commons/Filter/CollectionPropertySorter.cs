...
using Yuebon.Commons.Exceptions;
using Yuebon.Commons.Extensions;
using Yuebon.Commons.Properties;

namespace Yuebon.Commons.Filter
{
    /// <summary>
    /// 集合类型字符串排序操作类
    /// </summary>
    ...
    public static class CollectionPropertySorter<T>
    {
        ...
        private static LambdaExpression GetKeySelector(string keyName)
        {
            ...
            foreach (string propertyName in propertyNames)
            {
                ...
                if (property == null)
                {
                    throw new YuebonFWException(string.Format(Resources.ObjectExtensions_PropertyNameNotExistsInType, propertyName));
                }
