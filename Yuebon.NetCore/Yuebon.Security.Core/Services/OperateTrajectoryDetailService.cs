...
namespace Yuebon.Security.Services
{
    ...
    /// 
    /// </summary>
    public class OperateTrajectoryDetailService : BaseService<OperateTrajectoryDetail, OperateTrajectoryDetailOutputDto, string>, IOperateTrajectoryDetailService
    {
