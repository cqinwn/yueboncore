...
namespace Yuebon.WebApp.Areas.Security.Controllers
{
    ...
    public class ItemsDetailController : BusinessController<ItemsDetail, ItemsDetailOutputDto, IItemsDetailService, string>
    {
        ...
        public override IActionResult GetById(string id)
        {
            ...
            catch (Exception ex)
            {
                ...
                Log4NetHelper.Error(type, "获取数据字典异常", ex);//错误记录
