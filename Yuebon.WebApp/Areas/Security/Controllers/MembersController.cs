...
namespace Yuebon.WebApp.Areas.Shop.Controllers
{
    ...
    public class MembersController : BusinessController<User, UserOutputDto, IUserService, string>
    {
        ...
        public MembersController(IUserService _iService, IOrganizeService _organizeService, IRoleService _roleService, IUserLogOnService _userLogOnService) : base(_iService)
        {
            iService = _iService;
            ...
            AuthorizeKey.ExtendKey = "Members/ResetPassword";
        }
