    ...
    <el-card>
      <div class="list-btn-container">
        <el-button-group>
          ...
          <el-button v-hasPermi="['TaskManager/Enable']" type="success" icon="el-icon-video-play" size="small" @click="setEnable('1')">启用</el-button>
          <el-button v-hasPermi="['TaskManager/DeleteSoft']" type="warning" icon="el-icon-delete" size="small" @click="deleteSoft('0')">软删除</el-button>
          <el-button v-hasPermi="['TaskManager/Delete']" type="danger" icon="el-icon-delete" size="small" @click="deletePhysics()">删除</el-button>
          <el-button v-hasPermi="['TaskManager/ChangeStatus']" type="info" icon="el-icon-video-pause" size="small" @click="setStatus('0')">暂停</el-button>
          <el-button v-hasPermi="['TaskManager/ChangeStatus']" type="success" icon="el-icon-video-play" size="small" @click="setStatus('1')">启动</el-button>
